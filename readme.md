...
> "Our system uses TF-IDF with Cosine Similarity for NLP-based grievance classification, Supabase PostgreSQL for real-time data persistence, Streamlit for the UI, and a standalone Python scheduler that enforces 24-hour SLA compliance by automatically escalating unresolved grievances to the Department Head — completely independent of user activity."
